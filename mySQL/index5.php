<?php
	...
	//$query = "UPDATE exampleDB.users SET `name`='John Draper' WHERE `name`='John'";

	$name = "Brit";

	$query = "select name from exampleDB.users where name='".mysqli_real_escape_string($link, $name)."'";
